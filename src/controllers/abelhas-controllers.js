import { getAbelhaPorIdService, getAbelhasPorEstadoService, getTodasAbelhasService, updateNomePopularService } from "../services/abelhas-services.js";
...
export async function updateNomePopularController(req, res) {
    const { id } = req.params
    const { nome } = req.body
    await updateNomePopularService(nome, id)
    res.sendStatus(200)
}